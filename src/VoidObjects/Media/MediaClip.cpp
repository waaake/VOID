...
{   
    WriteString(out, m_View.media.Basepath());
    WriteString(out, m_View.media.Name());
    WriteString(out, m_View.media.Extension());

    bool singlefile = m_View.media.SingleFile();
    unsigned int padding = m_View.media.Framepadding();
