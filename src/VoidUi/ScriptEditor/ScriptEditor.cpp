...
void PyScriptEditor::Build()
{
    ...
    m_ExecAllButton->setIcon(IconForge::GetIcon(IconType::icon_play_arrow, _DARK_COLOR(QPalette::Text, 100)));
    m_ExecAllButton->setToolTip(ToolTipString("Execute", "Execute all code.").c_str());

    m_ExecSelectionButton = new QPushButton;
    m_ExecSelectionButton->setIcon(IconForge::GetIcon(IconType::icon_segment, _DARK_COLOR(QPalette::Text, 100)));
    ...
    m_SaveScriptButton->setIcon(IconForge::GetIcon(IconType::icon_save, _DARK_COLOR(QPalette::Text, 100)));
    m_SaveScriptButton->setToolTip(ToolTipString("Save Script", "Saves current Script.").c_str());

    m_LoadScriptButton = new QPushButton;
    m_LoadScriptButton->setIcon(IconForge::GetIcon(IconType::icon_file_open, _DARK_COLOR(QPalette::Text, 100)));
    m_LoadScriptButton->setToolTip(ToolTipString("Open Script", "Open a python script.").c_str());

    m_ClearOutputButton = new QPushButton;
    m_ClearOutputButton->setIcon(IconForge::GetIcon(IconType::icon_computer_cancel, _DARK_COLOR(QPalette::Text, 100)));
