 ...
 */
class VOID_API ToggleStatePushButton : public QPushButton
{
public:
 ...
 */
class VOID_API HighlightToggleButton : public QPushButton
{
public:
 ...
 */
class VOID_API ColorSelectionButton : public QPushButton
{
    Q_OBJECT
public:
 ...
 */
class VOID_API CloseButton : public QToolButton
{
public:
 ...
 */
class VOID_API MenuToolButton : public QToolButton
{
public:
