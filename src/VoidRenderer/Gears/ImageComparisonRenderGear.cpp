...
#include "ImageComparisonRenderGear.h"

VOID_NAMESPACE_OPEN

ImageComparisonRenderGear::ImageComparisonRenderGear()
    : m_VAO(0)
    , m_VBO(0)
    , m_IBO(0)
    , m_UProjection(-1)
...
void ImageComparisonRenderGear::Initialize()
{
...
void ImageComparisonRenderGear::Draw(const void* data)
{
    ...
    glBindTexture(GL_TEXTURE_2D, d->textureB);
     ...
     */
    glUniform1i(m_UComparisonMode, d->comparisonMode);

    /**
     * Update the blend mode on the shader
     */
    glUniform1i(m_UBlendMode, d->blendMode);
...
void ImageComparisonRenderGear::PostDraw()
{
    /* Cleanup */
    /* Unbind texture */
