#ifndef _VOID_SWIPER_SHADER_PROGRAM_H
#define _VOID_SWIPER_SHADER_PROGRAM_H
...
class SwiperShaderProgram : public ShaderProgram
{
public:
    SwiperShaderProgram() = default;
    ~SwiperShaderProgram();
...
#endif // _VOID_SWIPER_SHADER_PROGRAM_H
