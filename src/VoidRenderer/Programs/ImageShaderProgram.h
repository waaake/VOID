...
#ifndef _VOID_IMAGE_SHADER_PROGRAM_H
#define _VOID_IMAGE_SHADER_PROGRAM_H
...
class ImageShaderProgram : public ShaderProgram
{
public:
    ImageShaderProgram() = default;
    ~ImageShaderProgram();
...
#endif // _VOID_IMAGE_SHADER_PROGRAM_H
